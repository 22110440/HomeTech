...
function AdminDashboard() {
  const [activeTab, setActiveTab] = useState('repairSchedules');
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'repairCategories':
        return <RepairCategoriesManagement />;
    ...
    <div className={styles.container}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          <MenuBtn tab="repairCategories" label="DM sửa chữa" icon="M4 6h16M4 12h10M4 18h7" />
          <MenuBtn tab="repairSchedules" label="Lịch sửa chữa" icon="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
